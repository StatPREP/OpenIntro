...
1. Identify the variable by name and describe its meaning.
2. Describe the shape of the distribution for that variable.
3. Were you surprised by the shape or did it make sense to you? Write a sentence or two explaining your answer.

If you find any that are left-skew, write those down too.


### Code Block for Exloring Distributions
...
## To think about ...
DANNY: I'm not sure what to do with this. I could assign a reflection question (something to post in a discussion board or include in their Lab Report). Or we could just leave it out of the Lab.
