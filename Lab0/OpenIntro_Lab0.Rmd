...
<!--
```{ child = system.file("shiny/login/login-mockup.Rmd", package = "submittr")}
```
 -->
...
Now your turn .... In the next box, type in the command to pull out `num_char`, `line_breaks`, and `dollar` from the Email_50 dataframe. You can use "Run Code" to try out any command you compose. If you press "Submit," the tutorial will figure out if you've done the right thing and give you a hint if you haven't.
